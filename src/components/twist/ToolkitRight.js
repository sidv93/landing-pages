...
import Background from '../../assets/twist/illustration-element-04.svg';
import FeatureImage from '../../assets/twist/feature-split-image-02.svg';
...
const ToolkitRight = () => {
    return (
        <ToolkitContainer>
            <ImageContainer>
                <Image src={FeatureImage} alt="placeholder" />
            </ImageContainer>
            <TextContainer>
...
export default withFade(ToolkitRight);